/// @description string_real_abbreviate(real,decimals)
/// @param real
/// @param decimals
...
function string_real_abbreviate(argument0, argument1) {
	...
	else if( Rea>=1000000000000000000 )
	{
	    Add="qt";
	    Div=power(10,18);
	}
	else if( Rea>=1000000000000000 )
	{
	    Add="qd";
	    Div=power(10,15);
	}
